...
Gem::Specification.new do |spec|
  ...
  spec.description   = "#{spec.summary} Deploys to all instances in a group, " \
                       "creates a fresh AMI post-deploy, and attaches the AMI to your AutoScale Group."
  spec.homepage      = "http://github.com/sixfeetover/capistrano-asg"
  spec.license       = "MIT"

  spec.files         = `git ls-files -z`.split("\x0").reject do |f|
    f.match(%r{^(bin|test|spec|features|vendor|tmp)/})
  end
